...
import com.example.reviewMovie.cache.dao.CacheDao;
...
public class CacheUtil {
	...
	/**
	 * This function fetches value from Cache of class type T Returns null if
	 * key is not found in Cache.</br>
	 * 
	 * @param <T>
	 ...
	 * @param propertyName
	 *            -- propertyName with which expiration time should be fetched
	...
	/**
	 * This function deletes value from Cache of class type T Returns null if
	 * key is not found in Cache.</br>
	 * 
	 * @param <T>
	 *            -- Class Type for object to be fetched.
	...
	public Boolean hardDeleteObjectFromCache(String key, int database) {
		cacheDao.deleteKeyFromRedis(key, database);
		return true;
	}
