package com.example.reviewMovie.cache.dao;
...
import com.example.reviewMovie.bean.RedisConstant;
...
public class CacheDao {
	...
	@Autowired
	@Qualifier("REDIS_INVENTORY_COUNT_UNICOM_USER_DATABASE")
	private RedisTemplate<String, Object> redisDatabase;
	...
	public RedisTemplate<String, Object> getRedisTemplate(int database) {
		...
		switch (database) {
		case RedisConstant.REDIS_DATABASE:
